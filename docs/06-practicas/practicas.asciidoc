...
Una tarea para revisar y actualizar las configuraciones en toda la pila de API. La revisión debe incluir: archivos de orquestación, componentes de API y servicios en la nube API8:2023 Configuración incorrecta de la seguridad (Security Misconfiguration) - OWASP API Security Top 10
