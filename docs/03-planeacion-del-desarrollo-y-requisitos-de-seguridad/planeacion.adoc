...
.Figura X. Diagrama de Flujo de Datos para la API REST del sistema de salud
...
A continuación se muestran varios ejemplos simplificados de árboles de amenazas para la API REST del sistema de salud, donde se identificaron las vulnerabilidades (de color rojo) y su posible mitigación (de color verde).

image::arbol1.png[Árbol de amenazas - Ejemplo 1]
image::arbol2.png[Árbol de amenazas - Ejemplo 2]
image::arbol3.png[Árbol de amenazas - Ejemplo 3]
image::arbol4.png[Árbol de amenazas - Ejemplo 4]
image::arbol5.png[Árbol de amenazas - Ejemplo 5]
